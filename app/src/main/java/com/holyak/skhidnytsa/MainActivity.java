...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findAll = (Button) findViewById(R.id.button);
        mOrder = (Button) findViewById(R.id.btnOrder);
        secButton = (Button) findViewById(R.id.secButton);
        secButton2 = (Button) findViewById(R.id.secButton2);
        ...
        secButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, ClosePlaceActivity.class);
        ...
        secButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, AboutVilligeActivity.class);
                startActivity(intent);
            }
        });
